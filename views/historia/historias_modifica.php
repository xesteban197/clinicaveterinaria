    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        <div class="container-fluid">
            <div class="container-flat-form">
                <div class="title-flat-form title-flat-blue">Modificar la historia <?php echo $data['id']; ?></div>
                <form class="form-horizontal" method="POST" action="index.php?c=historias&a=actualizar" autocomplete="off">
                    <div class="row">
                        <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                            <input type="hidden" id="id" name="id" value="<?php echo $data['id']; ?>" />
                            <div class="group-material">
                                <input type="number" class="material-control tooltips-general" name="mascota" required="" maxlength="5" value="<?php echo $data['historias']['mascota_id'] ?>">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>mascota</label>
                            </div>
                            <div class="group-material">
                                <input type="text" class="material-control tooltips-general" name="fecha" placeholder="20220101" required="" maxlength="200" value="<?php echo $data['historias']['fecha_creacion'] ?>" title="Escribe la fecha en el siguiente formato AAAAmmDD">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>fecha</label>
                            </div>
