...
<body>
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        <div class="text-center all-tittles">
            <div class="col-lg-13">
                <h2 class="text-center all-tittles"> listado de historias</h2>
                <table border=3 style="background-color:#DFF0D8; font-weight:bold;">
                    ...
                    <tbody>
                        <?php
                        foreach ($data["historias"] as $dato) {
                            echo "<tr>";
                            echo "<td>" . $dato["id"] . "</td>";
                            echo "<td>" . $dato["mascota_id"] . "</td>";
                            echo "<td>" . $dato["fecha_creacion"] . "</td>";
                            echo "<td><a href='index.php?c=historias&a=modificar&id=" . $dato["id"] . "'>Modificar</a></td>";
                            echo "<td><a href='index.php?c=historias&a=eliminar&id=" . $dato["id"] . "'>Eliminar</a></td>";
