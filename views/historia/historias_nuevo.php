    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        <div class="container-fluid">
            <div class="container-flat-form">
                <div class="title-flat-form title-flat-blue">Registrar un nueva historia</div>
                <form class="form-horizontal" method="POST" action="index.php?c=historias&a=guarda" autocomplete="off">
                    <div class="row">
                        <div class="col-xs-12 col-sm-8 col-sm-offset-2">

                            <div class="group-material">
                                <input type="number" class="material-control tooltips-general" name="mascota" required="" maxlength="5" data-toggle="tooltip" data-placement="top" title="Digite el id de la mascota">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>mascota</label>
                            </div>
                            <div class="group-material">
                                <input type="text" class="material-control tooltips-general" name="fecha" placeholder="20220101" required="" maxlength="200" data-toggle="tooltip" data-placement="top" title="Escribe la fecha en el siguiente formato AAAAmmDD">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>fecha</label>
                            </div>
