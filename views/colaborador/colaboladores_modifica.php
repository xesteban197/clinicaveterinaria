    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        <div class="container-fluid">
            <div class="container-flat-form">
                <div class="title-flat-form title-flat-blue">Modificar el colaborador <?php echo $data['id']; ?></div>
                <form class="form-horizontal" method="POST" action="index.php?c=colaboradores&a=actualizar" autocomplete="off">
                    <div class="row">
                        <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                            <input type="hidden" id="id" name="id" value="<?php echo $data['id']; ?>" />
                            <div class="group-material">
                                <input type="text" class="material-control tooltips-general" name="nombre" required="" maxlength="5" value="<?php echo $data['colaboradores']['nombre'] ?>">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>nombre</label>
                            </div>
                            <div class="group-material">
                                <input type="text" class="material-control tooltips-general" name="apellido" required="" maxlength="200" value="<?php echo $data['colaboradores']['apellido'] ?>">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>apellido</label>
                            </div>
                            <div class="group-material">
                                <input type="text" class="material-control tooltips-general" name="cargo" required="" maxlength="200" value="<?php echo $data['colaboradores']['cargo'] ?>">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>cargo</label>
                            </div>
                            <div class="group-material">
                                <input type="text" class="material-control tooltips-general" name="especialidad" required="" maxlength="200" value="<?php echo $data['colaboradores']['especialidad'] ?>">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>especialidad</label>
                            </div>
                            <div class="group-material">
                                <input type="text" class="material-control tooltips-general" name="tipo" required="" maxlength="200" value="<?php echo $data['colaboradores']['tipo_documento'] ?>">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>tipo de documento </label>
                            </div>
                            <div class="group-material">
                                <input type="number" class="material-control tooltips-general" name="documento" required="" maxlength="200" value="<?php echo $data['colaboradores']['documento_identificacion'] ?>">
                                <span class="highlight"></span>
                                <span class="bar"></span>
