...
<body>
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        <div class="text-center all-tittles">
            <div class="col-lg-13">
                <h2 class="text-center all-tittles"> listado de colaboradores</h2>
                <table border=3 style="background-color:#DFF0D8; font-weight:bold;">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 25%;">documento de identificacion</th>
                    ...
                    <tbody>
                        <?php
                        foreach ($data["colaboradores"] as $dato) {
                            echo "<tr>";
                            echo "<td>" . $dato["id"] . "</td>";
                            ...
                            echo "<td>" . $dato["documento_identificacion"] . "</td>";
                            echo "<td><a href='index.php?c=colaboradores&a=modificar&id=" . $dato["id"] . "'>Modificar</a></td>";
                            echo "<td><a href='index.php?c=colaboradores&a=eliminar&id=" . $dato["id"] . "'>Eliminar</a></td>";
