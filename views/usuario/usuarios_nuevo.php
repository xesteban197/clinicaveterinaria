    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        <div class="container-fluid">
            <div class="container-flat-form">
                ...
                <form class="form-horizontal" method="POST" action="index.php?c=usuarios&a=guarda" autocomplete="off">
                    <div class="row">
                        <div class="col-xs-12 col-sm-8 col-sm-offset-2">

                            <div class="group-material">
                                <input type="text" class="material-control tooltips-general" name="nombre" required="" maxlength="200" title="Digite el nombre del usuario">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>nombre</label>
                            </div>
                            <div class="group-material">
                                <input type="text" class="material-control tooltips-general" name="apellido" placeholder="" required="" maxlength="200" data-toggle="tooltip" data-placement="top" title="Escribe la fecha en el siguiente formato AAAAmmDD">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>apellido</label>
                            </div>
                            <div class="group-material">
                                <input type="text" class="material-control tooltips-general" name="tipo" placeholder="" required="" maxlength="200" data-toggle="tooltip" data-placement="top" title="Escribe el tipo de tu documento">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>tipo de documento</label>
                            </div>
                            <div class="group-material">
                                <input type="text" class="material-control tooltips-general" name="documento" placeholder="" required="" maxlength="200" data-toggle="tooltip" data-placement="top" title="Escribe el numero de documeto">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>documento de identificacion</label>
                            </div>
                            <div class="group-material">
                                <input type="text" class="material-control tooltips-general" name="estado" placeholder="" required="" maxlength="200" data-toggle="tooltip" data-placement="top" title="activo o inactivo">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>estado</label>
                            </div>
                            <div class="group-material">
                                <input type="number" class="material-control tooltips-general" name="sexo" placeholder="" required="" maxlength="1" data-toggle="tooltip" data-placement="top" title="1 masculino 2 femenino">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>sexo</label>
                            </div>
