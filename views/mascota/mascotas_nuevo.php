    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        <div class="container-fluid">
            <div class="container-flat-form">
                <div class="title-flat-form title-flat-blue">Registrar nueva mascota</div>
                <form class="form-horizontal" method="POST" action="index.php?c=mascotas&a=actualizar" autocomplete="off">
                    <div class="row">
                        <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                            ...
                            <div class="group-material">
                                <input type="text" class="material-control tooltips-general" name="raza" placeholder="" required="" maxlength="200">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>raza</label>
                            </div>
                            <div class="group-material">
                                <input type="number" class="material-control tooltips-general" name="dueno" placeholder="" required="" maxlength="200" title="Escribe el id del dueño de la mascota">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>dueño</label>
                            </div>
                            <div class="group-material">
                                <input type="text" class="material-control tooltips-general" name="sexo" placeholder="" required="" maxlength="200">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>sexo</label>
                            </div>
