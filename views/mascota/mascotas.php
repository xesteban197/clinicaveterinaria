...
<body>
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        <div class="text-center all-tittles">
            <div class="col-lg-13">
                <h2 class="text-center all-tittles"> listado de mascotas</h2>
                <table border=3 style="background-color:#DFF0D8; font-weight:bold;">
                    ...
                    <tbody>
                        ...
                        foreach ($data["mascotas"] as $dato) {
                            ...
                            echo "<td><a href='index.php?c=mascotas&a=modificar&id=" . $dato["id"] . "'>Modificar</a></td>";
                            echo "<td><a href='index.php?c=mascotas&a=eliminar&id=" . $dato["id"] . "'>Eliminar</a></td>";
