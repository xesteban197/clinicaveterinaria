    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        <div class="container-fluid">
            <div class="container-flat-form">
                <div class="title-flat-form title-flat-blue">Modificar la mascota <?php echo $data['id']; ?></div>
                <form class="form-horizontal" method="POST" action="index.php?c=mascotas&a=actualizar" autocomplete="off">
                    <div class="row">
                        <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                            <input type="hidden" id="id" name="id" value="<?php echo $data['id']; ?>" />
                            <div class="group-material">
                                <input type="text" class="material-control tooltips-general" name="nombre" required="" maxlength="5" value="<?php echo $data['mascotas']['nombre'] ?>">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>nombre</label>
                            </div>
                            <div class="group-material">
                                <input type="text" class="material-control tooltips-general" name="raza" placeholder="20220101" required="" maxlength="200" value="<?php echo $data['mascotas']['raza'] ?>" title="Escribe la fecha en el siguiente formato AAAAmmDD">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>raza</label>
                            </div>
                            <div class="group-material">
                                <input type="number" class="material-control tooltips-general" name="dueno" placeholder="20220101" required="" maxlength="200" value="<?php echo $data['mascotas']['usuario_id'] ?>" title="Escribe la fecha en el siguiente formato AAAAmmDD">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>dueño</label>
                            </div>
                            <div class="group-material">
                                <input type="text" class="material-control tooltips-general" name="sexo" placeholder="20220101" required="" maxlength="200" value="<?php echo $data['mascotas']['sexo'] ?>" title="Escribe la fecha en el siguiente formato AAAAmmDD">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>sexo</label>
                            </div>
